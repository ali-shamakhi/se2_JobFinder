...
$(function() {
    $("form[name='am_user_registration']").validate({
        rules: {
            "am_user_registration[fName]":{
                required:true,
                maxlength:50,
                lettersonly:true
            },
            "am_user_registration[lName]":{
                required:true,
                maxlength:50,
                lettersonly:true
            },
            "am_user_registration[gender]":{
                required:false
            },
            "am_user_registration[karjoo][grade]":{
                required:false
            },
            "am_user_registration[soldiering]":{
                required:false
            },
            "am_user_registration[birth_year]":{
                number:true,
                required:false,
                maxlength:4,
                minlength:4,
            ...
            "am_user_registration[karjoo][student_id]":{
                required:false,
                number:true,
                maxlength:8,
                minlength:8
            },
            "am_user_registration[karjoo][national_id]":{
                required:true,
                maxlength:10,
                minlength:10
            },
            "am_user_registration[mobile]":{
                number:true,
                required:true
            },
            "am_user_registration[email]":{
                email:true,
                required:true
            },
            "am_user_registration[username]":{
                required:true,
                alphanumeric:true,
                minlength:5,
                maxlength:255
            },
            "am_user_registration[plainPassword][first]":{
                required:true,
                minlength:6
            },
            "am_user_registration[plainPassword][second]":{
                required: true
            },
            "am_user_registration[karfarma][company_name]":{
                required:true,
                maxlength:100
            },
            "am_user_registration[karfarma][company_field]":{
                required:true,
                maxlength:100
            },
            "am_user_registration[karfarma][telephone]":{
                number:true,
                required: false
            },
            "am_user_registration[karfarma][company_email]":{
                required:true,
                maxlength:100,
                email:true
            },
            "am_user_registration[karfarma][address]":{
                required:true
            },
            "am_user_registration[captcha]":{
                required:true
            },
            "am_user_registration[karjoo][is_student]":{
                required:false
            },
            "am_user_registration[karjoo][current_university]":{
                required:false
            },
            "am_user_registration[karjoo][current_field]":{
                required:false
            },
            "am_user_registration[karjoo][licanse_univesity]":{
                required:false
            },
            "am_user_registration[karjoo][licanse_field]":{
                required:false
            },
            "am_user_registration[karjoo][fogh_licanse_field]":{
                required:false
            },
            "am_user_registration[karjoo][fogh_licanse_univesity]":{
                required:false
            },
            "am_user_registration[karjoo][phd_field]":{
                required:false
            },
            "am_user_registration[karjoo][phd_univesity]":{
                required:false
            }
        },
