...
(function (root, factory) {
    ...
    var defaults = {parallax: {effect: 1.5}, pauseVideoOnViewLoss: false, preventContextMenu: false, minimumVideoWidth: 400, onBeforeReady: function onBeforeReady() {
    ...
    var BackgroundVideo = function () {
        ...
        _createClass(BackgroundVideo, [
            {key: "init", value: function init(element, iteration) {
                this.el = element;
            ...
            {key: "videoReadyCallback", value: function videoReadyCallback() {
            ...
            {key: "setWindowDimensions", value: function setWindowDimensions() {
                this.windowWidth = document.documentElement.clientWidth;
                this.windowHeight = document.documentElement.clientHeight;
            }},
            {key: "requestTick", value: function requestTick() {
                if (!this.ticking) {
                    this.ticking = true;
                    window.requestAnimationFrame(this.positionObject.bind(this))
                }
            }},
            {key: "positionObject", value: function positionObject() {
                var scrollPos = window.pageYOffset;
                var _scaleObject = this.scaleObject(), xPos = _scaleObject.xPos, yPos = _scaleObject.yPos;
                if (this.options.parallax) {
                    if (scrollPos >= 0) {
            ...
            {key: "scaleObject", value: function scaleObject() {
                ...
                return{xPos: -parseInt((videoWidth - this.windowWidth) / 2), yPos: parseInt(videoHeight - this.windowHeight) / 2}
            }},
            {key: "calculateYPos", value: function calculateYPos(yPos, scrollPos) {
            ...
            {key: "setVideoWrap", value: function setVideoWrap(iteration) {
            ...
            {key: "setVideoProperties", value: function setVideoProperties() {
            ...
            {key: "insertVideos", value: function insertVideos() {
            ...
            {key: "addSourceToVideo", value: function addSourceToVideo(src, type) {
                var source = document.createElement("source");
                source.src = src;
                source.type = type;
                this.el.appendChild(source)
            }},
            {key: "detectBrowser", value: function detectBrowser() {
            ...
            {key: "shimRequestAnimationFrame", value: function shimRequestAnimationFrame() {
                var lastTime = 0;
            ...
            {key: "detect3d", value: function detect3d() {
                var el = document.createElement("p"), t, has3d, transforms = {WebkitTransform: "-webkit-transform", OTransform: "-o-transform", MSTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform"};
