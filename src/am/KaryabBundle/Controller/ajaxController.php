...
class ajaxController extends Controller
{
    public function searchTagsAction(Request $request)
    {
        ...
        $result = $this->getDoctrine()->getRepository('amKaryabBundle:SkillTag')->createQueryBuilder('o')
    ...
    public function sendRequestAction(Request $request){
        ...
        if($request->isXmlHttpRequest()) {
            ...
            $advertise = $this->getDoctrine()->getRepository('amKaryabBundle:Advertise')->findOnePublished($id);
