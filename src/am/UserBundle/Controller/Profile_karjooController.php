...
use am\UserBundle\Form\Profile_karjooFormType;
...
class Profile_karjooController extends Controller
{
    ...
    public function showAction()
    {
        ...
        return $this->render('@amUser/Profile/showKarjoo.html.twig', array(
            'user' => $user
        ));
    }
    ...
    public function showProfileAction(User $user,$rId)
    {
        ...
        $req=$this->getDoctrine()->getRepository('amKaryabBundle:jobRequest')->find($rId);
    ...
    public function editAction(Request $request)
    {
        ...
        return $this->render('@amUser/Profile/edit_karjoo.html.twig', array(
